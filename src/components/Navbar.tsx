      ...
      <nav className="relative px-2 sm:px-4 py-1  bg-gray-900 shadow-2xl">
        <div className="container flex flex-wrap items-center justify-between mx-auto">
          ...
          <button
            ...
            type="button"
            className={
              "inline-flex items-center p-2 ml-3 text-sm rounded-lg md:hidden focus:outline-none focus:ring-2  text-gray-400 hover:bg-gray-700 focus:ring-gray-600"
            }
          ...
          <div
            className={` w-full text-center md:block md:w-auto ${
              isOpen ? "" : "hidden"
            }`}
            id="navbar-default"
          >
            <ul className="flex flex-col md:mr-2 p-4 mt-4 border rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0  ">
              <li
                className="border md:border-0 rounded-lg"
                onClick={() => {
                  setIsOpen(!isOpen);
                }}
              >
